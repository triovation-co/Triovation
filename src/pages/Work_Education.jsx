...
const Work_Education = () => {
  ...
  return (
    <>
      {/* Card Section */}
      <div className="overflow-x-hidden mx-auto flex justify-center from-red-50 via-pink-50 to-white py-10 -mb-10 lg:-mb-30">
      ...
      {/* Workshop Section */}
      <main id="workshop" className="container mx-auto px-6 md:px-8 xl:px-12 flex items-center justify-center mt-20 lg:mt-40 scroll-mt-20 relative">
