    ...
    <>
      <div className="mx-auto flex justify-center from-red-50 via-pink-50 to-white py-5 mb-25 -mt-10">
        <div className="grid grid-cols-3 md:grid-cols-3 gap-10 xl:gap-20 mt-20 mx-4 sm:mx-10 lg:mx-20">
          ...
          {/* Card 2 - Manufacturing Support (Coming Soon) */}
          <div className="flex flex-col items-center w-full">
            <div
              className="relative w-full aspect-square rounded-[1rem] lg:rounded-[3rem] overflow-hidden shadow-md grayscale opacity-80"
            >
              <img
            ...
            <p className="block lg:hidden text-center text-sm font-semibold mt-2 text-gray-400">
              Manufacturing Support
            </p>
          </div>

          {/* Card 3 - Startup Venture Support (Coming Soon) */}
          <div className="flex flex-col items-center w-full">
            <div
              className="relative w-full aspect-square rounded-[1rem] lg:rounded-[3rem] overflow-hidden shadow-md grayscale opacity-80"
            >
      ...
      <main id="design-consultancy" className="container mx-auto px-6 md:px-8 xl:px-12 mt-20 scroll-mt-28 relative -mb-10">
      ...
      <main id="learning-zone" className="container mx-auto px-6 md:px-8 xl:px-12 mt-20 scroll-mt-20 relative">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-20 items-start">
          ...
          >
            ...
            <button disabled className="border-2 border-gray-400 rounded-lg p-2 px-8 text-gray-500 bg-gray-300 cursor-not-allowed">
