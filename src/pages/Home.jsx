...
import Triovation_main from "../assets/Triovation_main.jpg";
    ...
    <>
      <div className="overflow-x-hidden relative">
        ...
        <div className="fixed inset-0 pointer-events-none z-0">
          ...
          ></div>
          <div 
            className="absolute bottom-40 left-1/4 w-16 h-16 bg-gradient-to-br from-pink-200 to-orange-200 rounded-full opacity-25"
            style={{ transform: `translateY(${scrollY * 0.08}px) rotate(${scrollY * 0.1}deg)` }}
          ></div>
        </div>

        {/* Main Content Section */}
        <main className={`container mx-auto py-8 sm:py-5 md:py-10 lg:py-10 xl:py-20 px-4 sm:px-6 md:px-8 lg:px-10 relative z-10 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            ...
            <div className="relative flex justify-center md:justify-start group">
              <div
                className="rounded-t-full overflow-hidden 
                           ...
                           mx-auto bg-black relative transition-all duration-700 hover:scale-105 hover:shadow-2xl"
              >
                <img
                  src={Triovation_main}
            ...
            <div className="text-center md:text-left mt-20 space-y-6">
              ...
              <div className="space-y-4 text-gray-600 text-lg lg:text-xl xl:text-[19px] leading-relaxed">
                <p className="animate-fade-in-up delay-200">
                  TRIOVATION is a one stop platform where imagination takes shape as reality. We are a creative group that transforms concepts into crafted realities through our four core domains: Design, Corporate Gifting, Startup Venture, and Education.
                </p>
                <p className="animate-fade-in-up delay-400">
                  We merge creativity with precision, offering a full suite of services from custom product design and manufacturing to personalized corporate hampers. Beyond a focus on physical products, we also foster creativity through hands on learning experiences, including engaging workshops.
                </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-1 gap-10 lg:gap-16 xl:gap-24 items-center">
            <div className="text-center md:text-left order-2 md:order-1 space-y-6">
              ...
              <p className="text-gray-600 text-lg lg:text-xl xl:text-xl leading-relaxed hover:text-gray-700 transition-colors duration-300">
                <strong className="text-[#f47e82]">TRIOVATION</strong> is a creative collective bringing together design, manufacturing, gifting, and hands-on education on a single platform. Our expertise lies in transforming abstract ideas into tangible products and experiences from custom corporate hampers to product design consultancy and machine-learning workshops.
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-3 gap-6 sm:gap-8 px-4 sm:px-6 lg:px-12 mb-16">
          {[
            ...
            <div
              key={card.id}
              className={`relative group bg-white rounded-2xl shadow-lg p-6 sm:p-8 flex flex-col items-center text-center
                         transition-all duration-700 max-w-sm mx-auto w-full
                         hover:-translate-y-6 hover:shadow-2xl hover:shadow-[#f47e82]/20
                         border border-transparent hover:border-[#f47e82]/30
                         animate-fade-in-up`}
            ...
            >
              ...
              {/* Circle Badge */}
              <div className="relative h-14 w-14 sm:h-16 sm:w-16 rounded-full bg-gradient-to-br from-[#f47e82] to-[#fca5a5] 
                              flex items-center justify-center mb-4 sm:mb-5 shadow-lg shadow-[#f47e82]/30
                              transform group-hover:scale-125 group-hover:rotate-12 transition-all duration-700 z-10">
              ...
              >
                ...
                <div
                  className="rounded-t-full overflow-hidden 
                            ...
                            lg:w-60 lg:h-60 
                            xl:w-74 xl:h-80 
                            mb-4 relative transition-all duration-700 hover:scale-110 hover:shadow-xl hover:shadow-[#f47e82]/20"
                >
                  <img
                    src={img}
                    alt={service}
                  ...
                  {/* Animated Border */}
                  <div className="absolute inset-0 rounded-t-full border-2 border-[#f47e82]/30 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                </div>
