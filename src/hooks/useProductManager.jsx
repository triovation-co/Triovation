...
export const useProductManager = () => {
  ...
  const fetchCategories = useCallback(async () => {
    try {
      console.log('🏷️ Fetching categories from Google Sheets...');
  ...
  const fetchProducts = useCallback(async (sortBy = 'featured') => {
    try {
      setLoading(true);
      setError(null);
      console.log('📦 Fetching products from Google Sheets with sorting:', sortBy);
      ...
      console.log('✅ Products fetched successfully:', finalProducts.length);
